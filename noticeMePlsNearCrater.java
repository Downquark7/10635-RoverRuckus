...
@Disabled
public class noticeMePlsNearCrater extends OpMode {
    ...
    public void init() {
        ...
        askState(new state("rotate right towards wall", 0, 0, 55));
        askState(new state("move towards wall", 38, 0, 0));
        askState(new state("rotate towards crater", 0, 0, 80));
        askState(new state("square up to wall", 0, -16, 0));
        askState(new state("distance from wall", 0, 3, 0));
        askState(new state("drive towards near crater", 22, 0, 0));
        askState(states.armDownAtCarry);
        askState(states.obtainCube);
        askState(states.armAtCarry);
        askState(states.reverseVexy);
        askState(states.sleep500);
        askState(states.deactivateVexy);
        askState(states.coastForward);
